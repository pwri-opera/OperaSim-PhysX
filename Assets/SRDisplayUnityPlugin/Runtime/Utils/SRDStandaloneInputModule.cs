...
namespace SRD.Utils
{
    ...
    public class SRDStandaloneInputModule : StandaloneInputModule
    {
        ...
        protected override MouseState GetMousePointerEventData(int id)
        {
            ...
            if(created)
            {
                leftData.position = _srdCameras.ScreenToSRDScreen(SRDApplicationWindow.GetSRDMousePos(input.mousePosition));
            }

            Vector2 pos = _srdCameras.ScreenToSRDScreen(SRDApplicationWindow.GetSRDMousePos(input.mousePosition));
