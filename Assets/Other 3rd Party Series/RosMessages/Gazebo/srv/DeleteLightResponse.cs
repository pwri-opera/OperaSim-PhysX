...
namespace RosMessageTypes.Gazebo
{
    ...
    public class DeleteLightResponse : Message
    {
        ...
        public static DeleteLightResponse Deserialize(MessageDeserializer deserializer) => new DeleteLightResponse(deserializer);

        private DeleteLightResponse(MessageDeserializer deserializer)
        {
