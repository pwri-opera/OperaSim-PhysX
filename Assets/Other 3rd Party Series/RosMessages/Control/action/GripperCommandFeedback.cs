...
namespace RosMessageTypes.Control
{
    ...
    public class GripperCommandFeedback : Message
    {
        ...
        public static GripperCommandFeedback Deserialize(MessageDeserializer deserializer) => new GripperCommandFeedback(deserializer);

        private GripperCommandFeedback(MessageDeserializer deserializer)
        {
